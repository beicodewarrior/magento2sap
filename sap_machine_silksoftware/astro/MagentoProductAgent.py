...
# Embedded file name: C:\magedst\astro\MagentoProductAgent.py
# Compiled at: 2017-05-03 00:56:08
import sys
sys.path.insert(0, '..')
...
class MagentoProductAstro(MagentoProduct):
    ...
    def formatProductJsonExt(self, formattedProductJsonObj, sourceProduct, productAttributesMap):
        ...
        elif formattedProductJsonObj['action'] is None:
    ...
    def importInvenoryExt(self, productId, product, syncResult):
        ...
        return syncResult
# okay decompiling MagentoProductAgent.pyc
