...
# Embedded file name: ..\MAGE2\MageDSTSync.py
...
class MagentoDSTSync(object):
    ...
    def __init__(self, mageConf, dstConf):
        ...
        self.dstQueries = {'getTaskLastCutOffDateSQL': 'SELECT max(last_cutoff_dt) FROM sync_control WHERE task = %s', 
    ...
    def syncCustomerToMage(self, syncStatus='N', througApi=False):
        ...
        return
# okay decompiling MageDSTSync.pyc
