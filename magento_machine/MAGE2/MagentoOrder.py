...
# [GCC 7.5.0]
# Embedded file name: /opt/magedst/MAGE2/MagentoOrder.py
...
class MagentoOrder(MagentoCore):
    ...
    def __init__(self, mageConf, mageConn=None, mageApi=None, dstCursor=None):
        ...
        self.mOrderQueryMap = {'fields': {'id': 'sales_order.entity_id', 'm_order_inc_id': 'sales_order.increment_id', 
        ...
        self.mOrderItemQueryMap = {'fields': {'id': 'sales_order_item.item_id', 'm_order_id': 'sales_order_item.order_id', 
        ...
        self.mOrderStatusHistoryQueryMap = {'fields': {'id': 'sales_order_status_history.entity_id', 'm_order_inc_id': 'sales_order.increment_id', 
        ...
        self._lastCutoffDt = ''
        self._orderToInvoiceMapping = {'baseCurrencyCode': 'base_currency_code', 'baseToGlobalRate': 'base_to_global_rate', 
        ...
        self._orderItemToInvoiceItemMapping = {'name': 'name', 'orderItemId': 'item_id', 
           'price': 'price', 
           ...
           'sku': 'sku'}
        self._orderToShipmentMapping = {'billingAddressId': 'billing_address_id', 'orderId': 'entity_id', 
           'customerId': 'customer_id', 
           'storeId': 'store_id'}
        self._orderItemToShipmentItemMapping = {'name': 'name', 'orderItemId': 'item_id', 
           'price': 'price', 
           'productId': 'product_id', 
           'sku': 'sku'}
    ...
    def syncMagentoOrderToDst(self):
        syncResult = {'sync_status': 'F', 'sync_notes': ''}
        try:
    ...
    def importShipment(self, eShipment):
        ...
        syncResult = {'id': eShipment['id'], 'm_order_inc_id': mOrderIncId, 
        ...
        try:
            ...
            if mOrderId is None:
                ...
                return syncResult
            shipmentData = {'entity': {'orderId': mOrderId, 'items': []}}
            mOrderIncId = eShipment['m_order_inc_id']
            ...
            for line in eShipment['lines']:
                ...
                if orderItemId is None:
                    ...
                    item = {'orderItemId': orderItemId, 'qty': qty}
            ...
            trackData = {'entity': {'carrierCode': 'custom', 'orderId': mOrderId, 
    ...
    def importCreditMemo(self, eCreditMemo):
        syncResult = {'id': eCreditMemo['id'], 'm_order_inc_id': eCreditMemo['m_order_inc_id'], 
        ...
        try:
            ...
            creditMemoData = {'qtys': items, 'shipping_amount': eCreditMemo['shipping_amount'], 'adjustment_positive': eCreditMemo['adjustment_positive'], 
    ...
    def updateMagentoOrderStatus(self, mOrder, updateOrderStatus):
        syncResult = {'id': mOrder['id'], 'm_order_inc_id': mOrder['m_order_inc_id'], 
           'sync_status': 'F', 
           'sync_notes': ''}
        try:
    ...
    def importInvoice(self, mOrderId, items, comments=[], orderData={}, includeShippingAmount=True):
        syncResult = {'m_order_id': mOrderId, 'm_invoice_id': None, 
    ...
    def captureInvoice(self, invoiceId):
        syncResult = {'m_invoice_id': invoiceId, 'sync_status': 'F', 
           'sync_notes': ''}
        try:
