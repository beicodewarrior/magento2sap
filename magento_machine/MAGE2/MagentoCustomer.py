...
# [GCC 7.5.0]
# Embedded file name: /opt/magedst/MAGE2/MagentoCustomer.py
...
class MagentoCustomer(MagentoCore):
    ...
    def __init__(self, mageConf, mageConn=None, mageApi=None, dstCursor=None):
        ...
        self._mCompanyDefaults = {'status': '1', 'website_code': 'base', 
           'created_at': self.getNowStr('UTC'), 
           'updated_at': self.getNowStr('UTC'), 
           'action': 'addOrUpdate'}
        self._customerDefaults = {'website_code': 'base', 'store_code': 'default', 
        ...
        self._companyAccountRoleMatrix = {'Admin': 0, 'Manager': 1, 
           'Salesperson': 2}
    ...
    def getCustomerByEmail(self, email, websiteCode, storeCode):
        ...
        res = self.mageCursor.fetchone()
        customer = {'entity_id': None, 'email': email, 
           'group_id': None, 
           'customer_group': None, 
           'website_code': websiteCode, 
           'store_code': websiteCode}
        if res is not None:
            customer = {'entity_id': res[0], 'email': res[1], 'group_id': res[2], 'customer_group': res[3], 
               'website_code': res[4], 
               'store_code': res[5]}
        return customer
    ...
    def importCustomerAddress(self, mCustomer, eCustomerAddress, eCustomerAddressAttributesMap={}):
        ...
        syncResult = {'action': '', 'unique_id': uniqueValue, 
           'customer_id': mCustomerId, 
           'm_address_id': None, 
           'sync_status': 'F', 
           'sync_notes': 'DST to Magento'}
        try:
            mCustomerAddressId = self.getCustomerAddressByUniqueValue({self._eCustomerAddressUniqueKey: uniqueValue, 'parent_id': mCustomerId})
    ...
    def importCompany(self, eCompany, eCompanyAttributesMap={}):
        ...
        syncResult = {'id': eCompany['id'], 'action': '', 
        ...
        try:
            ...
            if existingCompany['id'] == 0 and self._createNewCompany == True:
                ...
                if self._createNewCompany == False:
